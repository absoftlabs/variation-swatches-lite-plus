...
<h2>
	<?php esc_html_e( 'How to tutorials', 'variation-swatches-lite-plus' ); ?>
</h2>

<div id="variation-swatches-lite-plus-tutorials-wrapper">
	...
	<ul>
		...
		<li>
			<div class="tutorial-image-wrapper">
				<?php if ( ! woo_variation_swatches()->is_pro() ) : ?>
					<div class="ribbon"><span><?php esc_html_e( 'PRO', 'variation-swatches-lite-plus' ); ?></span></div>
				<?php endif; ?>
			...
			<div class="tutorial-description-wrapper">
				...
				<div class="tutorial-contents">
					Generally, the variation comes with feature images. If your product variations have it’s featured image set, premium version can convert your variation select drodown into image swatches just after installation. No Configuration would be needed. Best for
					<strong>Printful</strong>, <strong>Alidrop</strong>, And other
					<strong>Dropshipping</strong> as well as <strong>Multi Vendor</strong> Plugins
				</div>
				<div class="tutorial-buttons">
					<a href="https://demo.getwooplugins.com/woocommerce-variation-swatches/product-details/enable-auto-image-and-size-swatches/" target="_blank" class="button button-live-demo">Live Video Preview</a>
		...
		<li>
			...
			<div class="tutorial-image-wrapper">
				<?php if ( ! woo_variation_swatches()->is_pro() ) : ?>
					<div class="ribbon">
						<span><?php esc_html_e( 'PRO', 'variation-swatches-lite-plus' ); ?></span>
					</div>
				<?php endif; ?>
		...
		<li>
			...
			<div class="tutorial-description-wrapper">
				<h3>Categorize &amp; Group Swatches</h3>
				<div class="tutorial-contents">
