		...
		<div class="gwp-backbone-modal-content">
			<section class="gwp-backbone-modal-main" role="main">
				<header class="gwp-backbone-modal-header">
					<h1><?php esc_html_e( 'QUICK FEEDBACK', 'variation-swatches-lite-plus' ); ?></h1>
					<button class="modal-close modal-close-link dashicons dashicons-no-alt">
						<span class="screen-reader-text"><?php esc_html_e( 'Close modal panel', 'variation-swatches-lite-plus' ); ?></span>
					</button>
				</header>
				<article>
					<div class="gwp-feedback-dialog-form-body">

						<h2><?php esc_html_e( 'May we have a little info about why you are deactivating?', 'variation-swatches-lite-plus' ); ?></h2>
				...
				<footer>
					<div class="inner">
						<div class="gwp-action-button-group">
							<button id="send-ajax" class="button button-primary feedback-dialog-form-button-send" data-defaultvalue="<?php esc_html_e( 'Send feedback &amp; Deactivate', 'variation-swatches-lite-plus' ); ?>" data-deactivating="<?php esc_html_e( 'Deactivating...', 'variation-swatches-lite-plus' ); ?>"><?php esc_html_e( 'Send feedback &amp; Deactivate', 'variation-swatches-lite-plus' ); ?></button>
							<span class="spinner"></span>
						</div>

						<a class="feedback-dialog-form-button-skip" href="{{ data.deactivate_link }}"><?php esc_html_e( 'Skip &amp; Deactivate', 'variation-swatches-lite-plus' ); ?></a>
						<div class="clear"></div>
					</div>
				</footer>
			</section>
