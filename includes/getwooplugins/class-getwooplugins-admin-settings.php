...
if ( ! class_exists( 'GetWooPlugins_Admin_Settings', false ) ) :
	...
	class GetWooPlugins_Admin_Settings {
		...
		public static function save() {
			...
			self::add_message( esc_html__( 'Your settings have been saved.', 'variation-swatches-lite-plus' ) );
		...
		*/
		...
		public static function popup_template_links($value) {
			...
			if ( !empty($value['is_pro']) ) {
				$text = is_string($value['is_pro']) ? $value['is_pro'] : esc_html__('Check how this feature works.', 'variation-swatches-lite-plus');
			...
			if (!empty($value['help_preview']) ) {
				$text = is_string($value['help_preview']) ? $value['help_preview'] : esc_html__('See how this feature works', 'variation-swatches-lite-plus');
