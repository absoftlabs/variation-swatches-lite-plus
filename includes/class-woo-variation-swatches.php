...
if ( ! class_exists( 'Woo_Variation_Swatches' ) ) {
	...
	class Woo_Variation_Swatches {
		...
		public function show_archive_page_swatches_by_id( $product_id ) {
			...
			$align_slug = ( 'center' === $archive_align ) ? 'center' : ( 'flex-end' === $archive_align ? 'right' : 'left' );

			$wrapper_attributes = array(
				'class'                  => 'woo-variation-swatches wvs-archive-variations-wrapper woo_variation_swatches_variations_form wvs-archive-align-' . $align_slug,
