...
if ( ! class_exists( 'Woo_Variation_Swatches_Backend' ) ) {
	class Woo_Variation_Swatches_Backend {
		...
		public function plugin_action_links( $links ) {
			$action_links = array(
				'settings' => '<a href="' . esc_url( $this->get_admin_menu()->get_settings_link( 'woo_variation_swatches' ) ) . '" aria-label="' . esc_attr__( 'View Swatches settings', 'variation-swatches-lite-plus' ) . '">' . esc_html__( 'Settings', 'variation-swatches-lite-plus' ) . '</a>',
			);


			$pro_links = array(
				'gwp-go-pro-action-link' => '<a target="_blank" href="' . esc_url( $this->get_pro_link() ) . '" aria-label="' . esc_attr__( 'Go Pro', 'variation-swatches-lite-plus' ) . '">' . esc_html__( 'Go Pro', 'variation-swatches-lite-plus' ) . '</a>',
			);
		...
		public function product_option_terms( $attribute_taxonomy, $i, $attribute ) {
			...
			<select multiple="multiple"
					...
					data-placeholder="<?php esc_attr_e( 'Select values', 'variation-swatches-lite-plus' ); ?>"
				...
				?>
					...
					<button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'variation-swatches-lite-plus' ); ?></button>
					<button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'variation-swatches-lite-plus' ); ?></button>
					<button class="button fr plus add_new_attribute"><?php esc_html_e( 'Create value', 'variation-swatches-lite-plus' ); ?></button>
		...
		public function admin_scripts() {
			...
			wp_enqueue_style( 'variation-swatches-lite-plus-admin', woo_variation_swatches()->assets_url( "/css/admin{$suffix}.css" ), array(), woo_variation_swatches()->assets_version( "/css/admin{$suffix}.css" ) );
			...
			wp_enqueue_script( 'variation-swatches-lite-plus-admin', woo_variation_swatches()->assets_url( "/js/admin{$suffix}.js" ), array(
				'jquery',
			...
			wp_localize_script( 'variation-swatches-lite-plus-admin', 'woo_variation_swatches_admin', array(
				'media_title'    => esc_html__( 'Choose an Image', 'variation-swatches-lite-plus' ),
				'dialog_title'   => esc_html__( 'Add Attribute', 'variation-swatches-lite-plus' ),
				'dialog_save'    => esc_html__( 'Add', 'variation-swatches-lite-plus' ),
				'dialog_cancel'  => esc_html__( 'Cancel', 'variation-swatches-lite-plus' ),
				'button_title'   => esc_html__( 'Use Image', 'variation-swatches-lite-plus' ),
				'add_media'      => esc_html__( 'Add Media', 'variation-swatches-lite-plus' ),
				'ajaxurl'        => esc_url( admin_url( 'admin-ajax.php', 'relative' ) ),
				'wc_ajax_url'    => WC_AJAX::get_endpoint( '%%endpoint%%' ),
				'settings_url'   => esc_url( $this->get_admin_menu()->get_settings_link( 'woo_variation_swatches' ) ),
				'settings_title' => esc_html__( 'Variation Swatches Settings', 'variation-swatches-lite-plus' ),
				'_wpnonce'          => wp_create_nonce( 'woo_variation_swatches' ),
				'reset_notice'   => esc_html__( 'Are you sure you want to reset it to default setting?', 'variation-swatches-lite-plus' ),
				'nav_warning'    => esc_html__( 'Please save changed first.', 'variation-swatches-lite-plus' ),
			) );
		}
		...
		public function attribute_types() {
			...
			return array(
				'select' => esc_html__( 'Select', 'variation-swatches-lite-plus' ),
				'color'  => esc_html__( 'Color', 'variation-swatches-lite-plus' ),
				'image'  => esc_html__( 'Image', 'variation-swatches-lite-plus' ),
				'button' => esc_html__( 'Button', 'variation-swatches-lite-plus' ),
				'radio'  => esc_html__( 'Radio', 'variation-swatches-lite-plus' ),
			);
		}
		...
		public function extended_attribute_types() {
			...
			// $attribute_types[ 'custom' ] = esc_html__( 'Custom', 'variation-swatches-lite-plus' );
			$attribute_types[ 'mixed' ] = esc_html__( 'Mixed', 'variation-swatches-lite-plus' );
		...
		public function attribute_meta_fields() {
			...
			$fields[ 'color' ] = array(
				array(
					'label' => esc_html__( 'Color', 'variation-swatches-lite-plus' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'variation-swatches-lite-plus' ), // description
			...
			$fields[ 'image' ] = array(
				array(
					'label' => esc_html__( 'Image', 'variation-swatches-lite-plus' ), // <label>
					'desc'  => esc_html__( 'Choose an Image', 'variation-swatches-lite-plus' ), // description
