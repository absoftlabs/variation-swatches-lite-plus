...
Variation Swatches Lite+ makes selecting product options easier and more enjoyable. Say goodbye to dull dropdown menus—your customers can now choose sizes, colors, styles, and more using vibrant swatches, images, and labels.
...
The best part? Variation Swatches Lite+ automatically convert all variation select dropdowns into buttons right after installation—only a quick two-step configuration is needed for color and image swatches.
...
👉 Auto Convert All Variation Dropdowns to Button Swatch by Default
  ...
  You can easily convert the variation select options from drop-down to buttons just by installing this Variation Swatches Lite+ plugin. It will automatically convert your product variation select dropdowns to button swatches once the plugin is installed. 
...
Globally created product attributes are used for many different products. With these Variation Swatches Lite+ plugin, you can globally create attributes into color, image, and label swatches. So, you don’t need to get inside each product of your store and enable variation swatches for them separately. 
...
Elementor works well with all the themes and plugins which respect the coding. The Variation Swatches Lite+ plugin is compatible with the Elementor page builder plugin.
...
Dokan Multivendor WooCommerce plugin and its functionalities are compatible with beautiful color, image, and button Variation Swatches Lite+ Product Attributes.
...
[Live Demo](http://bit.ly/3rd-main-demo-readme) | [Upgrade to PRO](http://bit.ly/upgrade-to-pro-readme) | [Documentation](https://getwooplugins.com/documentation/woocommerce-variation-swatches/?utm_source=wordpress.org&utm_medium=README&utm_campaign=variation-swatches-lite-plus) | [Support](https://getwooplugins.com/tickets/?utm_source=wordpress.org&utm_medium=README&utm_campaign=variation-swatches-lite-plus)
...
=== How To Show Variation Swatches Lite+ on Shop Page ===
...
With the help of Variation Swatches Lite+ plugin, you can show select attributes on archive page. So, don't worry if you have too many variations on the product page. 
...
This is another effective feature of the Variation Swatches Lite+ plugin. For example, if you decide to change the swatch type of color attribute into an image, you can do it easily with this Attribute Swatches plugin.   
...
In the Variation Swatches Lite+ plugin,there are options for styling swatches, such as rounded and squared attribute swatches shape. The round and square shapes are one of the unique features of this plugin. 
...
The advanced version of the Variation Swatches Lite+ plugin is useful for displaying out of stock variation swatches as blur. You can show unlimited variations without hiding stock items from the catalog.
...
You will have control over swatch size when you are using this Variation Swatches Lite+ plugin. You can decide how large or small the swatches will be on the product page. That means, you can set height, or width for the products for the shop page swatches.  
...
If you wish to let your customer know about the minimum stock of your product is left. This Variation Swatches Lite+ swatch plugin is very effective. It has the option to show all the remaining stock for variation products. 
...
The Variation Swatches Lite+ plugin converts filter products by attribute widget into color swatches. This feature of the Swatch plugin will reduce the number of results that the user has to look through. 
...
Variation Swatches Lite+ plugin allows customizing the title text and tooltip background from the admin backend. It also has the option to change text background color. 
...
Variation Swatches Lite+ plugin offers a simple setting to enable and disable swatches on archive pages. You can show or hide tooltips and clear links on archive pages.
...
= Sites Built With Variation Swatches Lite+ Plugin =
...
<h4>Pro Version</h4>
<ul>
<li><a target="_blank" href="https://getwooplugins.com/plugins/woocommerce-variation-swatches/?utm_source=wordpress.org&utm_medium=README&utm_campaign=variation-swatches-lite-plus">Pro Version</a></li>
</ul>
<ul>
<li><a target="_blank" href="https://getwooplugins.com/documentation/woocommerce-variation-swatches/?utm_source=wordpress.org&utm_medium=README&utm_campaign=variation-swatches-lite-plus">Documentation</a></li>
</ul>
...
<ul>
<li><a target="_blank" href="https://getwooplugins.com/?utm_source=wordpress.org&utm_medium=README&utm_campaign=variation-swatches-lite-plus">Visit Our Official Website</a></li>
</ul>
</blockquote>
...
3. Search **Variation Swatches Lite+**
...
* New: `add_theme_support( 'variation-swatches-lite-plus', array( 'tooltip' => FALSE, 'stylesheet' => FALSE ) );` for theme developer default setting control.
