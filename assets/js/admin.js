    ...
    return _createClass(PluginHelper, null, [{
      ...
      value: function GWPAdmin() {
        ...
        if ($().gwp_deactivate_popup) {
          $().gwp_deactivate_popup('variation-swatches-lite-plus');
        }
      }
    }, {
      key: "PaginationAjax",
      ...
      value: function AttributeTypeSwitch() {
        ...
        .on('change', 'select.woo_variation_swatches_attribute_term_type_switch', function (event) {
          var attribute_type = $(this).closest('.variation-swatches-lite-plus-attribute-options-wrapper').find('select.woo_variation_swatches_attribute_type_switch').val();
          if ($(this).val() !== attribute_type) {
            $(this).closest('.variation-swatches-lite-plus-attribute-options-wrapper').find('select.woo_variation_swatches_attribute_type_switch').val('mixed').trigger('change');
          }
        });
      }
    }, {
      ...
      value: function SetAttributeTypePaging(selector) {
        var attribute_type_val = $(selector).closest('.variation-swatches-lite-plus-attribute-options-wrapper').find('select.woo_variation_swatches_attribute_type_switch').val();
